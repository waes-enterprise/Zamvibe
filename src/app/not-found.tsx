  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="text-center max-w-md">
        <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-[#006633]/10 flex items-center justify-center">
          <svg className="w-12 h-12 text-[#006633]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
