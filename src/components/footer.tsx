      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-green-100/70 text-sm leading-relaxed max-w-xs">
              Zambia&apos;s Premier Property Marketplace — connecting property seekers with owners across Zambia.
            </p>
            {/* Social media icons */}
          ...
          {/* Company */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-green-300/80 mb-4">
              Company
            </h3>
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-green-100/50 text-sm">
              Zambia&apos;s Premier Property Marketplace
            </p>
          </div>
        </div>
      </div>
